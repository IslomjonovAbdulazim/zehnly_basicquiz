...
import '../controllers/guess_definition_controller.dart';
import '../controllers/word_blitz_controller.dart';

class GuessDefinitionPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // Get existing controller or create new one, then reset
    final GuessDefinitionController controller =
    Get.isRegistered<GuessDefinitionController>()
        ? Get.find<GuessDefinitionController>()
        : Get.put(GuessDefinitionController());
  ...
  Widget _buildQuizPage(GuessDefinitionController controller) {
  ...
  Widget _buildHeader(GuessDefinitionController controller) {
    return Row(
      children: [
        GestureDetector(
          onTap: () {
  ...
  Widget _buildProgressBar(GuessDefinitionController controller) {
    return Obx(
          () => Text(
  ...
  Widget _buildQuestionCard(GuessDefinitionController controller) {
    return Obx(
          () => Container(
        width: double.infinity,
        padding: EdgeInsets.all(24),
  ...
  Widget _buildAnswerOptions(GuessDefinitionController controller) {
    return Obx(
          () => Column(
  ...
  Widget _buildAnswerOption(
      GuessDefinitionController controller,
      String option,
      int index,
      ) {
  ...
  Widget _buildAnswerReveal(GuessDefinitionController controller) {
    return Scaffold(
      backgroundColor: Colors.transparent,
      body: Stack(
        children: [
  ...
  Widget _buildResultsPage(GuessDefinitionController controller) {
    return Padding(
      padding: EdgeInsets.all(20),
      child: Column(
